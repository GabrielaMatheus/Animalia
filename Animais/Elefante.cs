...
namespace animais.Animais
{
    class Elefante : Mamifero
    {
        ...
        {
            Console.WriteLine($"Informações do elefante:" +
        ...
        {
            Console.WriteLine("Elefante alimenando-se");
        }

        public override void Amamentar()
        {
            Console.WriteLine("Elefante amamentando");
        }

        public override void Comunicar()
        {
            Console.WriteLine("Elefante comunicando-se");
        }

        public override void Movimentar()
        {
            Console.WriteLine("Elefante movimentando-se");
        }
    }
}
