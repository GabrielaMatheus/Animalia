...
namespace animais.Animais
{
    class Chacal : Mamifero
    {
        ...
        {
            Console.WriteLine($"Informações do Chacal:" +
        ...
        {
            Console.WriteLine("Chacal Alimentando");

        }

        public override void Amamentar()
        {
            Console.WriteLine("Chacal Amamentando filhote");
        }

        public override void Comunicar()
        {
            Console.WriteLine("Chacal Comunicando");
